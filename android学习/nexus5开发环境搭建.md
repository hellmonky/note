...
privoxy官方网站：http://www.privoxy.org/sf-download-mirror/Sources/
找到最新的稳定版，然后编译后安装。
...
4. 选择特定的Android版本，如果是Nexus系列，你可以从关于手机中的版本号（build number）中从列表中找到对应的版本。也可以访问官方网站找到对应的版本：
...
上述章节中我们已经可以完整的编译整个代码了，但是查找和修改代码还是很不方便。如果有IDE支持就更加方便我们修改和编译整个AOSP。google为我们提供了Android Studio，可以用它来完成对AOSP源代码的查看和修改：
